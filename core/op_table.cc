    ...
    case 0x07: OP(RLC(A)              ,  1,  4, "0 0 0 C");
    ...
    case 0x0f: OP(RRC(A)              ,  1,  4, "0 0 0 C");
    ...
    case 0xd9: OP(RET(Cond::ALWAYS);ii.EI(),  1, 16, "- - - -");
    ...
    case 0xe0: OP(LD(IO(read8()),A)   ,  2, 12, "- - - -");
    ...
    case 0xf0: OP(LD(A,IO(read8()))   ,  2, 12, "- - - -");
    ...
    // case 0xf8: OP(LD(HL,SP+r8)        ,  2, 12, "0 0 H C");
