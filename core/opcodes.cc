    ...
    case 0x7: OP(RLC(A),1,4,'000C');
    case 0x8: OP(LD(Load16(U16),SP),3,20,'----');
    case 0x9: OP(ADD(HL,BC),1,8,'-0HC');
    case 0xA: OP(LD(A,Load(BC)),1,8,'----');
    case 0xB: OP(DEC(BC),1,8,'----');
    case 0xC: OP(INC(C),1,4,'Z0H-');
    case 0xD: OP(DEC(C),1,4,'Z1H-');
    case 0xE: OP(LD(C,U8),2,8,'----');
    case 0xF: OP(RRC(A),1,4,'000C');
    ...
    case 0x1F: OP(RR(A),1,4,'000C');
    case 0x20: OP(JR(CNZ,I8),2,12/8,'----');
    case 0x21: OP(LD(HL,U16),3,12,'----');
    ...
    case 0x31: OP(LD(SP,U16),3,12,'----');
    case 0x32: OP_RAW({ii.LD(Load(HL),A);ii.DEC(HL);},1,8,'----');
    ...
    case 0xF8: OP_RAW({ii.LD(HL,I8);ii.ADD(HL,SP);},2,12,'00HC');
    case 0xF9: OP(LD(SP,HL),1,8,'----');
    case 0xFA: OP(LD(A,Load(U16)),3,16,'----');
    case 0xFB: OP(EI(),1,4,'----');
    case 0xFE: OP(CP(U8),2,8,'Z1HC');
    case 0xFF: OP(RST(0x38),1,16,'----');
